...
var Importabular = /*#__PURE__*/function () {
  ...
  function Importabular(_ref2) {
    ...
    _defineProperty(this, "iframeStyle", {
      border: 'none',
    ...
    _defineProperty(this, "iframeBodyStyle", {
      padding: 0,
      margin: 0
    });

    _defineProperty(this, "events", ['mousedown', 'mouseenter', 'mouseup', 'mouseleave', 'touchstart', 'touchend', 'touchmove', 'keydown', 'paste', 'cut', 'copy']);
    ...
    _defineProperty(this, "mouseleave", function (e) {
      if (e.target === _this.tbody && _this.selecting) {
        _this.endSelection();
      }
    });
    ...
    _defineProperty(this, "touchend", function (e) {
      ...
      if (!_this.moved) {
        _this.changeSelectedCellsStyle(function () {
          _this.selectionEnd = _this.selectionStart = _this.getCoords(e);
        });
  ...
  _createClass(Importabular, [{
    key: "fillScrollSpace",
    value: function fillScrollSpace() {
    ...
    value: function setupDom() {
      ...
      this.events.forEach(function (name) {
        return cwd.addEventListener(name, _this3[name], true);
      });
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      this.destroyEditing();
      this.events.forEach(function (name) {
        return _this4.cwd.removeEventListener(name, _this4[name], true);
      });
    ...
    value: function setAllSelectedCellsTo(value) {
      ...
      this.forSelectionCoord(this.selection, function (_ref6) {
        var x = _ref6.x,
            y = _ref6.y;
        return _this6.setVal(x, y, value);
      });
    ...
    value: function moveCursor(_ref7, shiftSelectionEnd) {
      ...
      this.changeSelectedCellsStyle(function () {
        if (shiftSelectionEnd) {
          _this7.selectionEnd = nc;
        } else {
          _this7.selectionStart = _this7.selectionEnd = nc;
        }
      });
    ...
    key: "srollIntoView",
    value: function srollIntoView(_ref8) {
      var x = _ref8.x,
          y = _ref8.y;
      this.getCell(x, y).scrollIntoView({
        behavior: 'smooth',
        block: 'nearest'
      });
    }
    ...
    key: "startEditing",
    value: function startEditing(_ref9) {
      var x = _ref9.x,
          y = _ref9.y;
      this.editing = {
        x: x,
    ...
    value: function forSelectionCoord(_ref10, cb) {
      var rx = _ref10.rx,
          ry = _ref10.ry;
    ...
    key: "TDStyle",
    value: function TDStyle(x, y, _ref11) {
      var _this$options;
      ...
      return _objectSpread({
        ...
        borderStyle: 'solid',
        borderWidth: '1px',
        borderColor: editTarget && !editing ? 'black' : [y ? this.options.separatorColor : 'transparent', 'transparent', 'transparent', x ? this.options.separatorColor : 'transparent'].join(' '),
        boxSizing: 'border-box'
      }, cleanStyle((_this$options = this.options).cellStyle.apply(_this$options, arguments)));
    }
  }, {
    key: "contentStyle",
    value: function contentStyle(x, y, _ref12) {
      var _this$options2;

      var selected = _ref12.selected,
          onlySelected = _ref12.onlySelected,
          editTarget = _ref12.editTarget,
