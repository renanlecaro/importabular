(self.webpackChunkImportabular = self.webpackChunkImportabular || []).push([
  [826],
  {
    225: (t, e, i) => {
      ...
      class h {
        ...
        _onDataChanged() {
          this._options.onChange && this._options.onChange(this._data._toArr());
        }
        ...
        _tabCursorInSelection(t, e = 1) {
          ...
          let r;
          if (t) r = _shift(i, s, e, o[0], o[1] - 1, h[0], h[1] - 1);
          else {
            const t = _shift(s, i, e, h[0], h[1] - 1, o[0], o[1] - 1);
            r = { x: t.y, y: t.x };
          }
          this._fitBounds(r) &&
            (this._stopEditing(),
